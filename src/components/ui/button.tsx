...
const buttonVariants = tv({
  base: [
    "inline-flex items-center justify-center font-bold whitespace-nowrap rounded-md  ring-offset-background transition-colors",
    /* Disabled */
  ...
  variants: {
    ...
    size: {
      ...
      lg: "h-11 rounded-md px-8 text-2xl",
      icon: "size-10",
    },
  },
  defaultVariants: {
